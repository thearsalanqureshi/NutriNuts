...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA96736);
  late Color secondary = const Color(0xFFB85E2C);
  late Color tertiary = const Color(0xFFB9A46C);
  late Color alternate = const Color(0xFFE3E7ED);
  late Color primaryText = const Color(0xFF261F21);
  late Color secondaryText = const Color(0xFF7C7878);
